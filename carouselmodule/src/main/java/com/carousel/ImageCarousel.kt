...
import com.bishal.carouselmodule.R
import com.carousel.adapter.FiniteCarouselAdapter
import com.carousel.adapter.InfiniteCarouselAdapter
import com.carousel.listener.CarouselListener
import com.carousel.listener.CarouselOnScrollListener
import com.carousel.model.CarouselGravity
import com.carousel.model.CarouselItem
import com.carousel.model.CarouselType
import com.carousel.utils.CarouselLinearLayoutManager
import com.carousel.utils.LinearStartSnapHelper
import com.carousel.utils.dpToPx
import com.carousel.utils.getSnapPosition
import com.carousel.utils.spToPx
...
class ImageCarousel(
    ...
    private lateinit var cvRecyclerView: MaterialCardView
    ...
    private var topShadowAlpha: Float = 0f
        set(value) {
    ...
    private var bottomShadowAlpha: Float = 0f
        set(value) {
            field = getValueFromZeroToOne(value)
    ...
    @Dimension(unit = Dimension.PX)
    var cardViewRadius: Float = 0F
        set(value) {
            field = value

            cvRecyclerView.radius = value
        }


    private var cardViewElevation: Float = 0F
        set(value) {
            field = value
            cvRecyclerView.elevation = value
        }
    ...
    private var carouselType: CarouselType = CarouselType.BLOCK
        set(value) {
            field = value
    ...
    private var carouselGravity: CarouselGravity = CarouselGravity.CENTER
        set(value) {
            field = value
    ...
    private var scaleOnScroll: Boolean = false
        set(value) {
            field = value
    ...
    private var scalingFactor: Float = 0f
        set(value) {
            field = getValueFromZeroToOne(value)
     ...
     */
    private var autoWidthFixing: Boolean = false
        set(value) {
            field = value
    ...
    private var infiniteCarousel: Boolean = false
        set(value) {
            field = value
    ...
    private var touchToPause: Boolean = false
    ...
    private fun initViews() {
        ...
        cvRecyclerView = carouselView.findViewById(R.id.cvRecyclerView)
    ...
    private fun initAttributes() {
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                cardViewRadius = getDimension(
                    R.styleable.ImageCarousel_carouselRadius,
                    0.dpToPx(context).toFloat()
                )


                cardViewElevation = getDimension(
                    R.styleable.ImageCarousel_carouselElevation,
                    0.dpToPx(context).toFloat()
                )
     ...
     * @property data List of [CarouselItem].
     */
    private fun addData(data: List<CarouselItem>) {
        adapter?.apply {
     ...
     */
    private fun addData(item: CarouselItem) {
        adapter?.apply {
            val isFirstTime = this@ImageCarousel.data.isNullOrEmpty()
     ...
     */
    private fun initStartPositionForInfiniteCarousel() {
        if (!infiniteCarousel)
            return
